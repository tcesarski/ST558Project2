...
```{r, error = TRUE}
plot_g <- ggplot(df, aes(x = Area, y = Population, color = UN_Member)) +  geom_point() +
  labs(x = "Population",
       y = "Area", 
       fill = "Independence")
...
plot_boxplot <- ggplot(data_input, aes(x = Region, y = Population, fill = Region)) +
  geom_boxplot()
